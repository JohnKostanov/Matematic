//
//  MultiplicationBasicThree.swift
//  Matematic
//
...
class MultiplicationBasicThree: QuestionProtocol {
    ...
    var all: [Question] {
        return [
            Question(numberFirst: randomInt, numberSecond: randomIntTen, questionType: .multiplication, questionLevel: .medium),
            Question(numberFirst: randomInt, numberSecond: randomIntTen, questionType: .multiplication, questionLevel: .medium),
            Question(numberFirst: randomInt, numberSecond: randomIntTen, questionType: .multiplication, questionLevel: .medium),
            Question(numberFirst: randomInt, numberSecond: randomIntTen, questionType: .multiplication, questionLevel: .medium),
            Question(numberFirst: randomInt, numberSecond: randomIntTen, questionType: .multiplication, questionLevel: .medium),
